        ...
        <div className='home'>
            <div className='home__container'>
                ...
                <div className='home__row'>
                    <Product
                        id="4903332"
                        title="The Lean Startup: How Today's Entrepreneurs Use Continuous Innovation to Create Radically Successful Businesses Hardcover – Illustrated, September 13, 2011" alt=""
                        price={29.99}
                ...
                <div className='home__row'>
                    ...
                    <Product
                        ...
                        price={598.99}
                        rating={4}
                        image="https://m.media-amazon.com/images/I/51W2e10l3UL._AC_UY327_FMwebp_QL65_.jpg"alt=""
                    />
                </div>
                <div className='home__row'>
                    <Product
                        ...
                        price={1094.99}
                        rating={4}
                        image="https://m.media-amazon.com/images/I/61Hh-0F7AbL._AC_UY327_FMwebp_QL65_.jpg" alt=""/> 
                </div>
            </div>
        </div>
    )
